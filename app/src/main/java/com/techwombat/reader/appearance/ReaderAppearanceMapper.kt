...
object ReaderAppearanceMapper {
    val fontChoices = listOf(
        "serif" to "Serif", "sans-serif" to "Sans-serif", "monospace" to "Monospace",
        "cursive" to "Cursive", "open-dyslexic" to "OpenDyslexic",
        "accessible-dfa" to "AccessibleDfA", "ia-writer-duospace" to "iA Writer Duospace",
    )
    ...
    fun toEpubPreferences(appearance: ReaderAppearance): EpubPreferences {
        ...
        return EpubPreferences(
            fontFamily = when (normalized.fontFamily) {
                ...
                "open-dyslexic" -> FontFamily.OPEN_DYSLEXIC
                "accessible-dfa" -> FontFamily.ACCESSIBLE_DFA
